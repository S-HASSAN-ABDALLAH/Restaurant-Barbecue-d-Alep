...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'supprimer') {
    ...
    if (!isset($_POST['csrf_token']) || !verifyCsrfToken($_POST['csrf_token'])) {
        ...
        try {
            ...
            $stmt->execute([$id]);
            $_SESSION['flash_message'] = "Option supprimée avec succès";
            $_SESSION['flash_type'] = "success";
        } catch (PDOException $e) {
            error_log("Erreur suppression frite : " . $e->getMessage());
        ...
        <?php if (isset($_GET["message"])): ?>
            <script>
                Swal.fire({
                    ...
                    title: 'Succès!',
                    text: '<?php 
                        if ($_GET["message"] === "success") echo "Option ajoutée avec succès!";
                        elseif ($_GET["message"] === "updated") echo "Option modifiée avec succès!";
                    ?>',
                    confirmButtonColor: '#D4A853',
                    timer: 3000
                });
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <form method="POST" class="d-inline delete-form" data-name="<?= htmlspecialchars($frite["size"]) ?>">
